...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cars.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARS actions', async () => {
      const expectedActions = [
        {
