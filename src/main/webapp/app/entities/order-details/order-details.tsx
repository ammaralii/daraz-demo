            ...
            <tbody>
              {orderDetailsList.map((orderDetails, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{orderDetails.order ? <Link to={`/orders/${orderDetails.order.id}`}>{orderDetails.order.id}</Link> : ''}</td>
                  <td>{orderDetails.product ? <Link to={`/products/${orderDetails.product.id}`}>{orderDetails.product.id}</Link> : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/order-details/${orderDetails.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/order-details/${orderDetails.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
