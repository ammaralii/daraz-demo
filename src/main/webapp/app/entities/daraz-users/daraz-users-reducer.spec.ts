...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DARAZUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DARAZUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DARAZUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DARAZUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DARAZUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DARAZUSERS actions', async () => {
      const expectedActions = [
        {
