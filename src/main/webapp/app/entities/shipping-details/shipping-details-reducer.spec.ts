...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHIPPINGDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHIPPINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHIPPINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHIPPINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHIPPINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHIPPINGDETAILS actions', async () => {
      const expectedActions = [
        {
