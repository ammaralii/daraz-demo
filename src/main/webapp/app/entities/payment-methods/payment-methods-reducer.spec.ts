...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTMETHODS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYMENTMETHODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTMETHODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTMETHODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTMETHODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTMETHODS actions', async () => {
      const expectedActions = [
        {
