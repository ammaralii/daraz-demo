...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './colors.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLORS actions', async () => {
      const expectedActions = [
        {
