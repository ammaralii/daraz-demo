...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './products.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTS actions', async () => {
      const expectedActions = [
        {
