...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTDETAILS actions', async () => {
      const expectedActions = [
        {
