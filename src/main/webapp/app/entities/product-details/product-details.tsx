            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('isavailable')}>
                  Isavailable <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {productDetailsList.map((productDetails, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{productDetails.isavailable ? 'true' : 'false'}</td>
                  <td>
                    {productDetails.product ? <Link to={`/products/${productDetails.product.id}`}>{productDetails.product.id}</Link> : ''}
                  </td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/product-details/${productDetails.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
